...
Yarvin (in the manner of José Bonacci) states in this book that [democracy doesn’t work](https://www.421.news/en/imagine-state-ia-big-tech-accelerationism-en/). Unless, as in the well-known meme of office workers, if this is stated by Bonacci, we call Human Resources, but if Yarvin says it, we find it “interesting.” Ah, the price of being ugly and not living in [California](https://www.421.news/en/california-waves-punk-and-video-games-the-soundtrack-of-skateboarding/).

![](https://www.youtube.com/embed/PcRZeYCIXRk?feature=oembed)

The reasons why democracy doesn’t work are numerous, and a large part of Yarvin's intellectual project is to inventory all of them. In short, the democratic state is, for him, a rather ingenious way to dilute the sovereignty of the monarch. The result is an opaque bureaucracy in which there is no ultimate responsibility for the decisions made. The division of the three [powers](https://www.421.news/en/who-makes-the-federal-laws/) of the state produces a constant struggle among them, and politics, in the exclusive sense of the *political clique*, replaces good governance. That is the fundamental problem for Yarvin, who, in the manner of the old Aristotle from Politics (4th century BC), writes for a polis in inexorable decline. The solution is then an autocratic government where all political responsibility is exercised unilaterally by a single person. But isn’t that what happens in a dictatorship? What happens if the [monarch goes mad](https://www.421.news/en/alexander-charisma-empire-en/), or simply fails as such? Isn’t that precisely what republics and democracies were born to avoid? Well, Yarvin proposes the creation of a system that allows for the removal of the CEO/Monarch and replace him with another. To prevent coups, the entire military arsenal is isolated under cryptographic locks. Only authorization from the government shareholders, AKA Citizens, would enable the possibility of using the weapons to oust the rebellious Monarch/CEO. As always happens in technocratic utopias, technology solves a distinctly political problem: that of loyalty. A problem that has plagued [Javier Milei](https://www.421.news/en/the-milei-anomaly/) with leaks of his audios, Cristina Fernández de Kirchner with a vice president who votes against her, or the Roman emperors assassinated by the praetorian guard sworn to protect them. Not to mention the headbutt that John F. Kennedy took from the lead projectile allegedly fired by Lee Harvey Oswald. In short.
...
Yarvin proposes a complete revision of American history from his own reactionary perspective. He writes from 2008, during the height of Obamaism and also the greatest economic crisis since the 1930s. Coincidentally, the way out of that crisis marks, for Yarvin, the consolidation of a change in direction, already latent in the historical evolution of the American state. For the thinker, Roosevelt plays the same role as [Perón](https://www.421.news/en/peronist-golem-argentinas-failed-act/) for an Argentine gorilla. The entire model of government designed by professional bureaucracies, NGOs, and think tanks is a product of Roosevelt's government, at a time when the United States was closest to a [socialist dictatorship](https://www.421.news/en/disco-elysium-marxism-detectives-en/). Patience with this argument.
...
The devices that support the ideological unity of the Cathedral rely on universities, the media, and [Hollywood](https://www.421.news/en/hail-mary-hollywood-science-fiction-en/). Universities are the great creators of ideology and provide sustenance to all advanced, progressive social theories, acting as a battering ram for the chtulhic progressives. Next come the media, particularly the New York Times, which serves as a kind of programmatic validator of what academia indicates and also as a sounding board. “Hey, there’s this problem, let’s consult the experts.” The last leg is Hollywood, which takes everything and weaponizes it into “feelings”: from entertainment narratives to the performative politics of the star system (just look at what the Avengers' anti-Trump campaign was).
...
## Patchwork: a final solution for politics

The solution, for Yarvin, is the total liquidation of the current State through a transition program towards a corporate government. But not one, rather thousands. Each [city](https://www.421.news/en/techno-feudalism-what-are-the-main-projects-for-private-city-states/) and its area of influence must become an independent State. Thousands of independent States. In other words, what is commonly referred to as “balkanization.”
...
However, the United States military is one of the [great beneficiaries](https://www.421.news/en/palantir-surveillance-thiel-argentina-en/) of this order of things. It has the ability to somewhat steer the country's foreign policy, possesses one of the most advanced scientific and technical frameworks on the planet, has almost infinite resources, and best of all: it is not accountable for it, as the entire republican system functions as a protective shield. Why would it give up this privileged position? On what grounds?
...
A preliminary note: for those who are not interested in the entirety of Yarvin's work but want a brief firsthand glimpse, I recommend his article on [Elves and Hobbits](https://graymirror-substack-com.translate.goog/p/you-can-only-lose-the-culture-war?_x_tr_sl=en&_x_tr_tl=es&_x_tr_hl=es&_x_tr_pto=tc&_x_tr_hist=true&ref=421.news) in Gray Mirror, and his explanation of why the right is destined to always lose the 'cultural battle.'



> Classical international law, though it was never perfect, was simply a magnificent feat of engineering. It resolved—not perfectly, but quite effectively—a problem that today seems insurmountable to us: enforcing good behavior among sovereign nations without a central enforcer. One might call it a peer-to-peer architecture for world peace (...). I fear that what we have now is more of a client-server approach. It works, more or less. It does not strike me as stable or scalable. International law was designed for a world of equals. It collapsed when a nation—first Great Britain and, later, the United States—assumed the role, for superficially charitable and fundamentally Whig [progressive liberal] reasons, of acting as a global enforcer. At that point, it ceased to be an instrument of peace and independence and became one of domination and war. “That’s a different story.”



Curtis Yarvin, “An Open Letter to Open-Minded Progressives”, (2008).

The central problem we face, then, is that of a hegemonic power whose ideology is Protestant puritanism; in addition to having the mission of upholding this ideological line within its own borders—with all that entails—it is a major exporter of this ideology to the rest of the world. It does so in a way that demands varying degrees of ideological compliance from its counterparts, depending on the circumstances and the country’s importance on the global stage. Furthermore, as an empire that is, in a sense, opposed to the very notion of order and power, it is a machine for generating constant disorder in the international sphere. For Yarvin, this is one of the worst consequences of American hegemonic thought. And since it is impossible to reform it, it must be cut off at the root without further ado.

This is where Yarvin’s theory, ultimately, is an extremely anti-American expression, since it does not seek to uphold the values of the Founding Fathers of the United States or restore a bygone era. What Yarvin is saying is that the United States as it exists today is the product of having become one with the Whig faction and the idea of permanent revolution. And that includes George Washington himself. This is the fundamental difference between Yarvin and other strands of American conservative thought. For example, advocates of the right to bear arms, militiamen, preppers, and those who oppose the excessive influence of the federal government—let’s say, the modern MAGA-style Republican. Even that American does not dare to go against the Constitution and the American Revolution; on the contrary, he constantly tries to restore that ideal, to return to it.

For Yarvin, there is nothing to salvage, since if we were to return to that moment in a hundred or two hundred years, we would be in the same place. The solution, then, is the dissolution of the U.S. government (and of countries in general) into polis-style administrative units. A political project that is truly difficult to sell, even to the most radical conservatives. Nevertheless, it remains a good characterization of how this military-political machine called the United States operates—and helps us understand, among other things, how it is possible that, until not long ago, the CIA participated in LGBTIQ+ Pride Month celebrations.

![]()

Without much more to say, I’ll leave it to you to draw your own conclusions. For my part, I’m grateful to the author for stimulating my thinking, pushing my ideas to the extreme, using memes as an epistemic tool, discussing [Bitcoin](https://www.421.news/en/bitcoin-fools-gold/) seriously, employing [Tolkien’s ](https://www.421.news/en/jrr-tolkien-visiting-an-old-friend/)metaphors to talk about politics, and forcing me to think deeply about the foundations of what I consider to be political.

Everything that is *said* by a fat guy from end to end.



 ![Juan Ruocco  🧙‍♂️](https://storage.ghost.io/c/2b/7f/2b7f69fc-a243-4d2f-ae8e-db8312c6653a/content/images/2025/10/juan_ruocco-1.jpg)

 Written by
 [Juan Ruocco 🧙‍♂️](/author/juan-ruocco/)


Escribo. Nací en 1987 en la Ciudad de Buenos Aires. Publiqué tres libros de ficción y un ensayo. Fundé 421 y soy columnista en streaming.


 [


 ](https://x.com/@realjuanruocco)
 [


 ](https://instagram.com/realjuanruocco)
 [


 ](https://www.juanruocco.com/)
 [

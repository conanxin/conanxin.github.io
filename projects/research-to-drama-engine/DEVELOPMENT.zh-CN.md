...
当前已公开本网站、图解、开发文档，以及从原工作树导出的 sanitized Engine source release：[`conanxin/research-to-drama-skills`](https://github.com/conanxin/research-to-drama-skills)。公开树包含真实代码/规则文件、Schemas、Skills、必要测试与去隐私化 pilot，不公开私人邮件、个人地址、凭据、原始私人扫描、未筛选日志或完整私有研究 Git 历史。第三方内容保留独立上游与许可边界。
...
发布路径已经实际完成到 GitHub 公开仓库：原工作树 → sanitized release → MIT 公开仓库 → README 回链本站。公开仓库当前为 `conanxin/research-to-drama-skills`。研究等待和发布并行，但发布通过不等于史料核验通过。

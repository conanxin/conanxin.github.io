...
**核心观点：**
- **别急着辞职**: 副业不是后备计划，而是测试场
- **堆叠优势**: 让主业喂养副业，而非竞争
- **多个小赌注**: 同时运行多个小实验，而非孤注一掷
- **等待真问题**: 最好的生意来自"我痛恨这个解决方案"
- **耐心是超能力**: 但只有当你有收入时才能负担得起

**案例研究**: Jack Zhang (Airwallex创始人)
- 29岁拥有1000万美元，仍未辞职
- 同时经营银行工作、橄榄油进口、手机壳转售、房地产倒卖
- 从个人痛点（咖啡店跨境支付延迟3周）中发现真实问题
- 拒绝Stripe 12亿美元收购，因为不 desperate

**关键数据**:
- Airwallex 估值: 80亿美元
- 年处理支付额: 2350亿美元
- 收入4年增长: 1亿美元ARR → 10亿美元ARR

[阅读全文 →](articles/side-hustle-to-million-analysis.md)

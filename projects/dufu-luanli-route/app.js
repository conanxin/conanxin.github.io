...
const LOCATIONS = [
  ...
  },
  {
    ...
    poems: '《彭衙行》',
    quote: '“痴女饥咬我，啼畏虎狼闻”',
    articleMeaning: '家庭悲剧（幼女饿死）让杜甫第一次把个人痛苦写进诗里，而不是用典故或隐喻来处理。',
    travelTip: '彭衙故道',
    routeGroup: 'anshi'
  },
  {
...
const TIMELINE = [
  ...
  },
  {
    ...
    event: '安史之乱爆发，杜甫携家从白水逃往鄜州羌村。山路艰险，幼女饿死于彭衙道中。孩子啼哭、虎狼威胁——杜甫从一个士人变成了逃难的父亲。',
    poems: '《彭衙行》',
    why: '杜甫把家庭悲剧（幼女饿死）直接写入诗中，个体苦难不再是隐喻，而成为诗歌的直接对象。'
  },
  {
    year: '756/757',
    title: '投奔灵武，被俘，押回长安',

...
## Phase 1.6 — Appendix Link &amp; Copy Polish (2026-05-13)

**内容：**
- 修复附录页 Markdown 链接 404：为所有 .md 文件生成对应 .html 阅读页
- 修复摘要空格和海报页残句
- 弱化风险评级绝对表达（"全部低风险" → 需人工审稿确认）
- 放宽目标受众描述（改为更包容表达）
- 增加"原表达风险 → 重设计处理"对照表（6项）
- 增加"你可以这样阅读"三路径卡片
- 增加海报"影像任务"说明（5张海报各一行）
- 新增 doc page CSS 样式

**新增生成文件（11个 HTML）：**
- crisis_response/better_public_apology_draft.html
- crisis_response/crisis_response_strategy.html
- crisis_response/pinned_social_response.html
- crisis_response/media_qa.html
- crisis_response/internal_memo_employee_protection.html
- crisis_response/anti_doxxing_boundary_statement.html
- campaign_redesign/campaign_redesign_strategy.html
- campaign_redesign/campaign_copy_system.html
- campaign_redesign/poster_concepts.html
- campaign_redesign/campaign_risk_review.html
- campaign_redesign/revised_campaign_board.html
